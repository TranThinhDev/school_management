        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="alert alert-info mt-4">
                    ...
                    <ul class="mb-0">
                        <li>Chọn lớp, môn học và học kỳ cần export bảng điểm</li>
                        <li>Hệ thống sẽ tải về file Excel chứa toàn bộ điểm số của học sinh</li>
                        <li>File Excel có thể mở bằng Microsoft Excel hoặc các phần mềm tương thích</li>
                    </ul>
                </div>
            </main>
        </div>
